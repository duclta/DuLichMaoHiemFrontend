                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="file" id="pro_image" name="pictour[]" class="form-control" accept="image/*" multiple="multiple">
                            </fieldset>
                            ...
                            <div class="row lich-trinh pb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7">
                                            ...
                                            <div class="" style="margin-top: 43px;">
                                                <button class="btn btn-danger btn-xoa-lich-trinh btn-block" type="button"
                                        ...
                                        <div class="col-lg-5">
                                            <div class="form-group" >
                                                ...
                                                <input required id="img1" type="file" name="img1" class="form-control hidden poster" onchange="changeImg(this)" accept="image/*">
                                                <img id="image1" class="thumbnail avatar" height="200px"  style="max-width: 200px; width: 200px" src="img/new_seo-10-512.png">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea required class="form-control" id="inputOverview1" style="height: 200px;"
                                            placeholder="Giới thiệu về lịch trình" name="content1"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                        <hr style="border: 1px solid #c82333;">
                                </div>
                            </div>
                        </div>
                        <div class="row">
        ...
        `<div class="row lich-trinh pb-3">
            <div class="col-lg-6">
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="form-group" >
                            <label>Hình ảnh</label>
                            <input required id="img${i}" type="file" name="img${i}" class="form-control hidden poster" onchange="changeImg(this)" accept="image/*">
                            <img id="image${i}" class="thumbnail avatar" height="200px"  style="max-width: 200px; width: 200px" src="img/new_seo-10-512.png">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <textarea required class="form-control" id="inputOverview${i}" style="height: 200px;"
