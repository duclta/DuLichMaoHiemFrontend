...
<body class="app sidebar-mini rtl">
  <!-- Navbar-->
  <header class="app-header"><a class="app-header__logo" href="{{asset('admin/home')}}">Team14.com</a>
    ...
    <ul class="app-nav">
      ...
      <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i
        ...
        <ul class="dropdown-menu settings-menu dropdown-menu-right">
          ...
          <li><a class="dropdown-item" href="{{asset('logout')}}"><i class="fa fa-sign-out fa-lg"></i> Logout</a></li>
        </ul>
      </li>
    </ul>
  </header>
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item" href="manage_tickets.html"><i class="app-menu__icon fa fa-ticket"></i><span
      ...
      <li class="treeview"><a class="app-menu__item" href="" data-toggle="treeview"><i
        ...
        <ul class="treeview-menu">
          ...
          <li><a class="treeview-item" href="list_posts.html"><i class="icon fa fa-list"></i> Danh sách bài đăng</a>
          </li>
        </ul>
      </li>
      <li><a class="app-menu__item" href="comment.html"><i class="app-menu__icon fa fa-comment"></i><span
